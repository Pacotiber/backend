/* global Vue, APP_CONFIG, articleApi, CommentsGuide, ArticleMetadataGuide, DeleteArticleGuide */

// Vue runs directly in the browser. Edit this file, save it, then refresh.
const { computed, createApp, ref } = Vue

createApp({
  components: { CommentsGuide, ArticleMetadataGuide, DeleteArticleGuide },
  /**
