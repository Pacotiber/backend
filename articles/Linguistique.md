...
Linguistique appliquée, linguistique cognitive,  orthographe, grammatologie, cryptanalyse, déchiffrement, anthropologie linguistique, linguistique anthropologique, analyse critique du discours, psycholinguistique, acquisition du langage, traitement automatique des langues, reconnaissance vocale, reconnaissance du locuteur, synthèse vocale et, plus généralement, traitement de la parole, sont de telles disciplines. Il est visible que la linguistique comprend divers chantiers de recherche.
Si l'archéologie et les documents primaires écrits sont rares, interprétables ou font défaut, la linguistique peut aussi fournir des données aux historiens, réceptifs à ces informations lorsque l'histoire n'est pas impliquée dans les controverses militantes
...
Les linguistes utilisent une démarche purement descriptive lors de leurs recherches. Ils cherchent à décrire la langue telle qu’elle est utilisée et à expliquer la nature du langage, sans porter de jugements. Les instruments pour décrire la linguistique incluent la phonétique, la phonologie, la syntaxe, la lexicologie et la sémantique. Ces outils sont utilisés pour déterminer les différences entre les accents et dialectes régionaux d’une même langue.
La démarche prescriptive ou normative cherche à décrire comment une langue doit être utilisée, son « bon usage ». Cela inclut l’application des règles - ensemble de conventions linguistiques et grammaticales - pour déterminer si une langue est ou non bien utilisée. La linguistique prescriptive/normative est de mise lorsqu’une personne apprend une langue, elle constitue le « standard » de la langue. La prescription, souvent appliquée à l’écriture, peut aussi être utilisée pour la parole. La linguistique prescriptive peut aussi analyser un accent ou un dialecte régional, et le comparer à la langue « standard » pour souligner les incorrections commises par le locuteur. Les corrections apportées à un texte écrit sont aussi un exemple de linguistique prescriptive.
Par exemple, la phrase : « il veux pas que tu va rendre visite lui » sera soigneusement décrite : mots, sons, terminaisons et structure. Les grammairiens descriptifs analyseront la démarche mentale de la personne écrivant cette phrase. La linguistique prescriptive énoncera quant à elle des jugements, en indiquant les erreurs grammaticales et syntaxiques commises. Les grammairiens prescriptifs jugeront la phrase agrammaticale et en donneront probablement une version corrigée : « il ne veut pas que tu ailles lui rendre visite ».
La plus grande différence entre les deux démarches est que la première observe une langue de façon objective et sans porter de jugement, alors que la seconde porte un regard subjectif, en jugeant de ce qui est bien écrit ou non.
...
De même, dès les années 1940, des chercheurs ont tenté d'identifier un parler gay et lesbien. Ces recherches présupposaient l'existence d'une identité homosexuelle universelle. Déborah Cameron et Don Kulick en font une critique sévère dans leur ouvrage The language and sexuality reader publié en 2006.
...
L’ouvrage Parlers masculins, parlers féminins ? de Verena Aebischer et Claire Forel, publié en 1983, interroge les stéréotypes linguistiques et les stratégies conversationnelles et propose de dépasser la perspective différentialiste. Des travaux de sémiologie, de sémantique, de lexicologie mettent au jour les dissymétries lexicales, les désignations péjorantes s'appliquant aux femmes, l'occultation des femmes par le masculin dit « générique ». Ces travaux font le parallèle entre la dévalorisation et l'invisibilisation du féminin dans la langue et des femmes dans la société.
Trois ouvrages marquent une étape importante pour la recherche linguistique sur le genre en France. Il s'agit de Langage, genre et sexualité sous la direction d'Alexandre Duchêne et Claudine Moïse, publié en 2001 ; d' Intersexion : langues romanes, langues et genre de Fabienne Baider en 2011 et de La face cachée du genre. Langage et pouvoir des normes de Natacha Chetcuti et Luca Gréco en 2012.
...
Parmi les premiers linguistes d'importance, il convient d'évoquer Jacob Grimm, qui, en 1822, a compris et décrit la nature des modifications phonétiques touchant les consonnes dans les langues germaniques (modifications décrites dans la loi de Grimm). À sa suite, citons  Karl Verner, inventeur de la loi portant son nom, August Schleicher, créateur de la Stammbaumtheorie et Johannes Schmidt, qui a développé la Wellentheorie (modèle par vagues) en 1872.
Ferdinand de Saussure peut être considéré comme le fondateur de la linguistique structuraliste (ce terme lui étant postérieur) et, pendant longtemps, comme le père de la linguistique moderne. Il s'opposa au behaviorisme.
Edward Sapir, linguiste et anthropologue américain, contemporain de F. de Saussure, développa au début du XXe siècle la théorie dite du relativisme linguistique. Celle-ci démontre que le langage n'est pas seulement un moyen de communication. Il peut aussi servir à la représentation symbolique des objets. Sapir, par ce biais, donne au langage une fonction expressive et symbolique.
...
Gustave Guillaume, s'opposant à Saussure, étudie la langue d'un point de vue plus phénoménologique (Temps et verbe, 1929). De nombreux admirateurs perpétuent ou redécouvrent aujourd'hui sa théorie.
Le modèle formel du langage développé par Noam Chomsky, la grammaire générative et transformationnelle, s'est développé sous l'influence de son maître distributionnaliste, Zellig Harris, lequel suivait déjà fortement les préceptes distributionnalistes de Leonard Bloomfield. Ce modèle s'est imposé depuis les années 1960 dans le domaine de la linguistique cognitive (compétence et performance).
...
La linguistique, matière parfois aride, parvient dans certains cas à atteindre le grand public, de même que la sémiotique : en témoignent les ouvrages de vulgarisation d'Henriette Walter, Umberto Eco ou Jean-Marie Klinkenberg.
Sur les applications de la linguistique à la communication, il faut noter les travaux de Roman Jakobson, qui a établi un modèle linguistique de communication, composé de six fonctions associées à des agents de communication.
